        ...
        <div class="col-lg-6 col-md-8 mx-auto">
            <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Nouveau Employe</h3>
                </div>

                <form method="POST" action="{{route('employe_store')}}"  >
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <label for="numero">Numero</label>
                            <input type="number" class="form-control" id="id" value="{{($latest) ? $latest->id+1 : 1}}" name="numero" disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="d-lg-flex justify-content-lg-between ">
                            <div class="form-group w-100 mr-lg-1">
